...
## Twitter & Article Proof Format Rotation

### PROOF FORMAT ROTATION RULE (PERMANENT)

Never open more than 1 Twitter post per week with peer-story openers:
- "An exec I drove..."
- "A CEO I know..."
- "Someone I work with..."
- "An inside sales rep I know..."
- "A founder I talked to..."
- Any variation of "[role] I [verb]..."

**Why:** Repetition pattern erodes credibility. Sounds made up after 2-3 uses. CEO readers pattern-match this and dismiss the author as a fake.

Rotate across these 5 proof formats instead:

#### 1. PEER STORY (max 1x/week — rare = high impact)
"An exec I drove last month said something I haven't stopped thinking about..."

#### 2. NUMBERS-FIRST STAT (directional, no source needed)
"77% of SMBs say social drives leads. 12% can attribute revenue to it. That gap is the entire opportunity."

#### 3. CONTRARIAN OBSERVATION (pure POV, no story)
"Everyone's buying AI tools. Nobody's measuring AI debt. The bill comes due in 18 months."

#### 4. PATTERN CALL-OUT (plural, vague — not one specific person)
"Three SaaS companies asked me the same question this week: 'How do we know our AI investments are working?' Nobody has a clean answer."

#### 5. CHALLENGE/QUESTION HOOK (sharp question, no story)
"Quick test: name the last AI tool your team shipped vs. just 'evaluated.' If you can't, that's the problem."

### Applies To
- Twitter posts (x-autoposter generated content)
- Beehiiv newsletter intros
- Article hooks and section openers
- LinkedIn posts (when added to channel mix)

### Enforcement
- Before generating any Twitter batch, audit the last 7 days of posts. If 2+ already used peer-story format, the new batch must NOT use it.
- For articles: max 1 peer-story moment per article. Use it for the strongest emotional anchor only.
- For newsletter issues: max 1 peer-story per issue, and rotate which issue uses it.
